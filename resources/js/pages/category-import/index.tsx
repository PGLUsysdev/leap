                                    ...
                                    <Field className="mt-4">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span className="text-muted-foreground text-xs font-normal whitespace-normal">
                                                    Category → Items directly
                                                    with D=COA (no extra label
                                                    row)
                                                </span>
                                                <span className="text-muted-foreground/70 font-mono text-xs">
                                                    Cat 1 → items (coa 1), items
                                                    (coa 2) → Cat 1 - Total
                                                </span>
                                            </ToggleGroupItem>
                                        </ToggleGroup>
                    ...
                    >
                        <div className="rounded-lg border p-4">
                            <p className="mb-2 text-sm font-medium">
                                Verify procurement format per sheet (categories
                                not in additional)
                            </p>
                            <p className="text-muted-foreground mb-3 text-xs">
                                Checks each selected sheet (
                                {selectedSheets.length}) with its calibration (
                                {calibrationMode}) — cat → coa(s) → items → cat
                            ...
                            {hasAnyVerify && !allVerifyValid && (
                                <div className="mt-4 flex items-center gap-2 rounded-md border border-amber-200 bg-white p-2">
                                    ...
                                    <span className="text-xs">
                                        ...
                                        sheet(s) and proceed to extraction (they
                                        will show as{' '}
                                        <span className="font-medium">
                                            skipped: problematic
                                        </span>{' '}
                            ...
                            <div className="text-muted-foreground rounded-lg border p-8 text-center text-sm">
                                {hasAnyVerify ? (
                                    <>
                                        ...
                                        in Verify tab to proceed, or fix sheet
                                        format. ({selectedSheets.length} sheets
                                        selected,{' '}
                                        {
                                            Object.values(verifyResults).filter(
                                                (r) => r.valid,
                                    ...
                                    <>
                                        ...
                                        <div className="rounded-lg border">
                                            <div className="flex items-start justify-between gap-3 p-3">
                                                <div>
                                                    ...
                                                    <p className="text-muted-foreground text-xs">
                                                        ...
                                                        {selectedSheets.length}{' '}
                                                        sheets. Check to import.
                                                        Strict = exact
                                                        normalized match in DB.
                                                        Partial = substring (≥4
                                                        or whitelist
                                            ...
                                            <div className="text-muted-foreground px-3 pb-2 text-xs">
                                                ...
                                                is_additional = false (toggle
                                                per row if Additional).
                                            </div>
                                            ...
                                            <div className="text-muted-foreground p-3 text-xs">
                                                ...
                                                — selected {selected.size}. Each
                                                unique shows where it was found:{' '}
                                                <span className="font-mono">
                                                    Sheet1!F12
                                                </span>
                                        ...
                                        {extractResult.skippedProblematic
                                            ...
                                            <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
                                                <h4 className="text-xs font-semibold text-amber-900">
                                                    Skipped: Problematic (from
                                                    Verify) — per sheet
                                                </h4>
                                                <p className="text-xs text-amber-800">
                                                    Excluded rows flagged in
                                                    Verify (row or normalized
                                                    match) per sheet. Shown for
                                                    review.
                                                </p>
                                        ...
                                        <div className="flex items-center gap-2 rounded-lg border p-3">
                                            ...
                                            <span className="text-muted-foreground text-xs">
                                                ...
                                                {selected.size}/
                                                {extractResult.unique.length}.
                                                Additional flag per row (default
                                                false, sentinels is_additional
                                                false).
                                            </span>
                                        </div>
                                    </>
