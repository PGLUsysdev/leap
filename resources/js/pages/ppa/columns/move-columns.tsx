...
const isValidParentType = (
    ...
    return targetIndex !== -1 && sourceIndex !== -1 && targetIndex === sourceIndex - 1;
};
...
const columns = [
    ...
    columnHelper.accessor("name", {
        ...
        cell: (info) => {
            ...
            const isParent = source && isValidParentType(ppa.type, source.type, ppaTypes);
    ...
    columnHelper.display({
        ...
        cell: ({ row, table }) => {
            ...
            const isLastLeaf = ppaTypes.length > 0 && target.type === ppaTypes[ppaTypes.length - 1];
