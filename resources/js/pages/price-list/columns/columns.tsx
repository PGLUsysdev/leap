...
const columns = (canEdit: boolean, canDelete: boolean, canMove: boolean) => {
    ...
    cols.push(
        columnHelper.accessor("item_number", {
            ...
            size: 80,
            cell: (value) => (
                <div className="wrap-break-words whitespace-normal">{value.getValue()}</div>
            ),
        }),
        ...
        columnHelper.accessor("unit_of_measurement", {
            header: "UOM",
            size: 100,
            cell: (value) => <div className="whitespace-normal">{value.getValue()}</div>,
        }),
        ...
        columnHelper.accessor("chart_of_account_ppmp_category.ppmp_category.name", {
            ...
            size: 180,
            cell: (value) => (
                <div className="leading-tight whitespace-normal">{value.getValue()}</div>
            ),
        }),
