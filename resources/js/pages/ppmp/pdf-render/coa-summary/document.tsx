        ...
        <Document>
            <Page size={[612, 936]} orientation="landscape" style={styles.page}>
                ...
                <View>
                    ...
                    <Text style={styles.headerText}>{aipEntry?.ppa?.full_code || "-"}</Text>
                    <Text style={styles.headerText}>{aipEntry?.ppa?.name || "-"}</Text>
                </View>

                {/* Table */}
                <PpmpPdfTable columns={columns} rows={rows} headerStyle={headerRowNoBg} />
