// resources/js/pages/price-list-quantities-import/steps/calibrate-step.tsx
...
export function CalibrateStep({ s }: { s: PriceListQuantitiesImportState }) {
    ...
    const onChange = (patch: Partial<QuantitiesSheetConfig>) => {
    ...
    const onColumn = (
        patch: Partial<QuantitiesSheetConfig['columnConfig']>,
    ) => {
        onChange({
    ...
    const onRow = (patch: Partial<QuantitiesSheetConfig['rowConfig']>) => {
        onChange({
        ...
        <TabsContent value="calibrate" className="mt-4 flex flex-col gap-4">
            ...
            <div className="rounded-lg border p-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                    ...
                    <Field>
                        <FieldLabel>Qty Start Column (Jan)</FieldLabel>
                        <Input
                            value={cfg.columnConfig.qtyStart}
                            onChange={(e) =>
                                onColumn({
                        ...
                        />
                        <FieldDescription>
                            K — Jan qty, alternating qty/amount pairs (amounts
                            skipped)
                        </FieldDescription>
                    </Field>
                </div>
