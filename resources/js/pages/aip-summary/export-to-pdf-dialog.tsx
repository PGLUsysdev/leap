...
export default function ExportToPdfDialog({
    ...
    const [reviewedPosition, setReviewedPosition] = useState("OIC-Provincial Budget Officer");
    const [approvedName, setApprovedName] = useState("");
    const [approvedPosition, setApprovedPosition] = useState("Provincial Governor");
    const [conformeName, setConformeName] = useState("");
    const [conformePosition, setConformePosition] = useState(defaultConformePosition);
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="flex h-[100vh] flex-col gap-0 rounded-none p-0 sm:max-w-[100vw]">
                <DialogHeader className="flex flex-row items-center justify-between space-y-0 border-b p-4">
                    <DialogTitle>PDF Preview - AIP Summary {fiscalYear.year}</DialogTitle>
                    <DialogDescription className="sr-only">AIP Summary Report Preview</DialogDescription>
                </DialogHeader>

                <div className="flex flex-1 overflow-hidden">
                    <div className="flex w-[360px] shrink-0 flex-col gap-4 overflow-auto border-r bg-background p-4">
                        <FieldGroup>
                            <div className="text-sm font-semibold">Prepared by</div>
                            <Field>
                                <FieldLabel htmlFor="sig-prepared-name">Name</FieldLabel>
                                <Input
                            ...
                            <Field>
                                <FieldLabel htmlFor="sig-prepared-position">Position</FieldLabel>
                                <Input
                            ...
                            <div className="text-sm font-semibold">Reviewed by</div>
                            <Field>
                                <FieldLabel htmlFor="sig-reviewed-name">Name</FieldLabel>
                                <Input
                            ...
                            <Field>
                                <FieldLabel htmlFor="sig-reviewed-position">Position</FieldLabel>
                                <Input
                            ...
                            <Field>
                                <FieldLabel htmlFor="sig-approved-name">Name</FieldLabel>
                                <Input
                            ...
                            <Field>
                                <FieldLabel htmlFor="sig-approved-position">Position</FieldLabel>
                                <Input
                            ...
                            <div className="text-sm font-semibold">Conforme</div>
                            <Field>
                                <FieldLabel htmlFor="sig-conforme-name">Name</FieldLabel>
                                <Input
                            ...
                            <Field>
                                <FieldLabel htmlFor="sig-conforme-position">Position</FieldLabel>
                                <Input
                                    id="sig-conforme-position"
                                    placeholder="-"
                                    value={conformePosition}
                                    onChange={(e) => setConformePosition(e.target.value)}
                                />
                            </Field>
                        </FieldGroup>
                    </div>
