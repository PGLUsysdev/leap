...
const MyDocument = ({ sections, psComputationData }: MyDocumentProps) => {
    ...
    const effectivePsSection: SectionData = (() => {
        ...
        const computedTotal = coas.reduce((sum, coa) => sum + parseFloat(coa.amount), 0).toFixed(2);
    ...
    const currentYearWidth = parseFloat(COL_WIDTHS.firstSem) + parseFloat(COL_WIDTHS.secondSem);
    const firstSemShare = (parseFloat(COL_WIDTHS.firstSem) / currentYearWidth) * 100;
    const secondSemShare = (parseFloat(COL_WIDTHS.secondSem) / currentYearWidth) * 100;

    return (
        <Document>
            <Page size={[612, 1008]} orientation="landscape" style={styles.page}>
                <View style={styles.container}>
                    ...
                    <Text style={{ paddingBottom: 10 }}>Department/Office: {"_".repeat(35)}</Text>
                    ...
                    <View style={styles.table}>
                        ...
                        <View fixed style={{ display: "flex", flexDirection: "column" }}>
                            ...
                            >
                                ...
                                >
                                    <Text style={styles.tableHeaderCell}>Account Code</Text>
                                </View>
                                <View
                                    style={[
                                        styles.borderRight,
                                ...
                                >
                                    <Text style={styles.tableHeaderCell}>Past Year (Actual)</Text>
                                </View>
                                <View
                                    style={[
                                        styles.colGroup,
                                ...
                                >
                                    <Text style={styles.tableHeaderCell}>Current Year</Text>
                                    <View style={[styles.rowGroup, styles.nestedHeaderBorder]}>
                                        <View
                                            style={[
                                                styles.borderRight,
                                                {
                        ...
                        {sectionConfigs.flatMap((cfg) => {
                            ...
                            rows.push(
                                <View
                                    key={`${cfg.key}-header`}
                                    wrap={false}
                                    style={[styles.rowGroup, styles.dataRow, styles.tableRowBorder]}
                                >
                                    <View
                                        style={[
                                            styles.borderRight,
                            ...
                            rows.push(
                                ...
                                >
                                    <View
                                        style={[styles.borderRight, { width: COL_WIDTHS.object }]}
                                    >
                                        <Text
                                            style={{
                                                ...styles.tableCellLeft,
                                    ...
                                    <View
                                        style={[styles.borderRight, { width: COL_WIDTHS.pastYear }]}
                                    >
                                        <Text
                                            style={{
                                    ...
                                    <View
                                        style={[styles.borderRight, { width: COL_WIDTHS.firstSem }]}
                                    >
                                        <Text
                                            style={{
                                                ...styles.tableCellRight,
                        ...
                        >
                            <View style={[styles.borderRight, { width: COL_WIDTHS.object }]}>
                                <Text
                                    style={{
                                        ...styles.tableCellLeft,
                                        fontFamily: "Helvetica-Bold",
                    ...
                    <View style={styles.signatoriesContainer}>
                        <View style={styles.signatoryBlock}>
                            ...
                            <Text style={styles.signatoryRole}>Department Head</Text>
                        </View>
                        <View style={styles.signatoryBlock}>
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="flex h-[100vh] flex-col gap-0 rounded-none p-0 sm:max-w-[100vw]">
                <DialogHeader>
                    <DialogTitle className="sr-only">LBP Form No. 2 PDF Preview</DialogTitle>
                    <DialogDescription className="sr-only">
                        Preview of the Programmed Appropriation and Obligation by Object of
                        Expenditure.
                    </DialogDescription>
                </DialogHeader>

                <PDFViewer width="100%" height="100%" style={{ border: "none" }}>
                    <MyDocument sections={sections} psComputationData={psComputationData} />
                </PDFViewer>
            </DialogContent>
        </Dialog>
    );
