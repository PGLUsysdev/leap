        ...
        cell: (info) => {
            ...
            switch (num) {
                ...
                case '5-01-02-040':
                    return (
                        <span className="text-xs">
                            Occupied positions × ₱5,000/year
                        </span>
                    );
                case '5-01-02-050':
                    return (
                        <span className="text-xs">
                            Full-time × ₱50/day × working days + Part-time ×
                            ₱25/day × working days
                        </span>
                    );
                case '5-01-02-060':
                    return (
                        <span className="text-xs">
                            Occupied positions × ₱300/month × 12 months
                        </span>
                    );
                ...
                case '5-01-02-140':
                    return (
                        <span className="text-xs">
                            Total Annual Salaries (All Occupied) ÷ 12
                        </span>
                    );
                case '5-01-02-150':
                    return (
                ...
                case '5-01-03-020':
                    return (
                        <span className="text-xs">
                            Occupied positions × ₱100/month × 12 months
                        </span>
                    );
                case '5-01-03-030':
                    return (
                        <span className="text-xs">
                            Total Annual Salaries (All Occupied) × 2.5%
                        </span>
                    );
                case '5-01-03-040':
                    return (
                        <span className="text-xs">
                            Total Annual Salaries (All Occupied) × 1%
                        </span>
                    );
                default:
                    return (
