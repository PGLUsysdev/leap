...
export default function AppTableHeader({ officeLabel, plannedAmount }: AppTableHeaderProps) {
    ...
    return (
        <View fixed>
            ...
            <View style={[styles.row, styles.borderTop, styles.borderBottom, { height: 36 }]}>
                <View
                    style={{
                        width: spanWidth(0, 5),
                        borderLeftWidth: 0.5,
                ...
                >
                    <View style={{ borderBottomWidth: 0.5, flex: 2, justifyContent: "flex-end" }}>
                        <Text
                            style={[
                                styles.tableHeaderCell,
            ...
            <View style={[styles.row, styles.borderBottom, { height: 40 }]}>
                ...
                <View style={[{ width: width(1) }, styles.borderRight, styles.centered]}>
                    <Text style={styles.tableHeaderCell}>Description</Text>
                </View>
                <View style={[{ width: width(2) }, styles.borderRight, styles.centered]}>
                    <Text style={styles.tableHeaderCell}>UNIT</Text>
                </View>
                <View style={[{ width: width(3) }, styles.borderRight, styles.centered]}>
                    <Text style={styles.tableHeaderCell}>UNIT COST</Text>
                </View>
                <View style={[{ width: width(4) }, styles.borderRight, styles.centered]}>
                    <Text style={styles.tableHeaderCell}>QTY.</Text>
                </View>
                <View style={[{ width: width(5) }, styles.borderRight, styles.centered]}>
                    ...
                    <View style={{ flexDirection: "row", flex: 1 }}>
                        {["1ST QUARTER", "2ND QUARTER", "3RD QUARTER", "4TH QUARTER"].map(
                            (quarter, idx) => {
                                ...
                                const parentWidth = APP_COLUMN_WIDTHS.slice(6, 14).reduce(
                                    (a, b) => a + parseFloat(b),
                                    0,
                                );
                                ...
                                return (
                                    <View
                                        key={quarter}
                                        style={{ width: `${(groupWidth / parentWidth) * 100}%` }}
                                    >
                                        <View
                                            style={[
                                                styles.borderBottom,
