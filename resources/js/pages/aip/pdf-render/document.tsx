 ...
 */
function appRowStyleResolver(
    row: TableRow,
): { rowStyle?: object; textStyle?: object } | null {
    if (row.type === 'banner') {
            ...
            <Page size={[612, 936]} orientation="landscape" style={styles.page}>
                ...
                <View style={styles.footerSection} wrap={false}>
                    <View style={styles.certText}>
                        <Text>
                            This is to certify that the above procurement plan
                            is in accordance with the objective of this Office.
                        </Text>
                    </View>
                    ...
                    <View style={styles.signatureWrapper}>
                        ...
                        <View style={styles.sigBlock}>
                            <Text style={styles.sigName}>
                                {signatories.gov.trim() ||
                                    '____________________________'}
                            </Text>
                            <Text style={styles.sigTitle}>
                                {signatories.govPosition.trim() ||
                                    'Provincial Governor'}
                            </Text>
                        </View>
                    </View>
